...
if (role === 'individual') {
  document.querySelector('#slogan').innerHTML = 'Discover nearby charities.';
  ...
  document.querySelector('#slogan').innerHTML = 'The extra donations and help your charity deserves.';
